    ...
    public class UpdatePatientValidator : AbstractValidator<UpdatePatientDTO>
    {
        public UpdatePatientValidator()
        {
            RuleFor(x => x.DocumentType)
                ...
                .Must(BeValidDocumentType).WithMessage("Tipo de documento inválido")
            ...
            // VALIDACIÓN ACTUALIZADA DE TELÉFONO PARA UPDATE
        ...
        {
            return !birthDate.HasValue || birthDate.Value <= DateTime.Now;
        }
